...
app.use("/giftCategory", giftCategoryRouter);
...
app.use("/coinPlan", coinPlanRouter);
...
app.use("/liveHost", liveHostRouter);
...
app.use("/ViewStory", ViewStoryRoute);
...
app.use("/history", HostStoryRoute);
//History Route
const rattingRoute = require("./server/ratting/ratting.route");
app.use("/ratting", rattingRoute);
...
app.use("/randomMatchHistory", RandomMatchRoute);
...
//mongodb connection
mongoose.connect(
  `mongodb+srv://voloda:x5IqUhUw0HWLCXrO@volodaapp.j14gfjy.mongodb.net/?retryWrites=true&w=majority`,
  {
...
//function import for story deleted after 24 hour
const { expireStory } = require("./server/hostStory/hostStory.controller");
